...
import CreditCardIcon from '@mui/icons-material/CreditCard'; // Icono para tarjetas
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={2}>
                        <Card sx={{ p: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <Typography variant="h7" sx={{ ml: 2 }}>Cards</Typography>
                            </Box>
                            <IconButton component={Link} to="/cards">
                                <ArrowForwardIosIcon />
                            </IconButton>
                        </Card>
                    </Grid>
                    ...
                    <Grid item xs={12}>
                        <Card sx={{ height: '100%' }}>
                            <CardContent>
                                <Typography variant="h6" sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                    <CreditCardIcon sx={{ mr: 1, color: '#007eae' }} />
                                    Your Cards
                                </Typography>
                                <List dense>
                                    {cards.map((card) => (
                                        <ListItem key={card.id}>
                                            <ListItemText
                                                primary={`Cardholder: ${card.cardholderName}`}
                                                secondary={`Card Number: ${card.cardNumber}, Expiry: ${card.expiryDate}, CVV: ${card.cvv}`}
                                            />
                                        </ListItem>
                                    ))}
                                </List>
